...
namespace BarEventsManager.Controllers
{
    public class EventsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Description,StartTime,EndTime,GenreId,VenueId")] Events events)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Description,StartTime,EndTime,GenreId,VenueId")] Events events)
        {
            if (ModelState.IsValid)
            {
